...
def load(df, df_results, price_df):
    ...
    df_final.to_csv("next_week_supplies_2016.csv", index=False)
    #Save df_final to xml
    informe_final_XML.createXML(df_final, "next_week_supplies_2016.xml")
    ...
    print()
    print("All data saved in next_week_supplies_2016.csv")
